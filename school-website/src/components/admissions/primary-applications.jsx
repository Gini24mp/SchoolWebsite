function PrimaryApplications() {
  return (
    ...
    <h2 className="text-4xl font-extrabold text-rose-800 py-6 text-center dark:text-white">Primary School Applications</h2>
    ...
    <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        ...
        <div className="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
            <h2 className="text-3xl text-rose-800 font-bold sm:text-4xl">Required supporting documents</h2>
...
export default PrimaryApplications;